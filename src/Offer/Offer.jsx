...
const Offer = () => {
  return (
    ...
    <div className="container m-auto pt-3-xl">
            <div className='line'>
            ...
            <div className="paragraph offerend  mt-5 d-flex justify-content-evenly align-items-center">
                    ...
                    <p className='onepara d-none d-xl-block  '>At Pixarsart our aim is to create the most effective online presence for your <br />  brand. We use the latest technology to provide you with the most intuitive <br /> solutions to cater to all your business needs. We want to see your business <br /> thrive.</p>
             
         
                    <p className='twopara d-none d-xl-block'>Our Team over at Pixarsart are committed to providing creative and innovative <br /> solutions in Web and App Development, UI/UX Design, Backend Development, <br /> Digital Product Development, Server Management, Continuous Integration and <br /> Continuous deployment as well as effective eCommerce solutions. We are <br /> progressively working with clients with legacy systems as well as progressive  <br />technologies including VR and AR.</p>
