...
const Cards = () => {
  return (
    <>
    <div className="container-fluid g-0 bg-black text-white py-sm-5">
      
        <div className="container pt-3 d-flex flex-column justify-content-center align-items-center m-auto row">
              <div className="col-md-12 cardHeading  d-flex flex-column justify-content-center justify-content-md-around align-items-center m-auto">
              <h3 className='cardsheading pt-sm-5'>
               Our Featured Blogs
               </h3>
    ...
    <div className="row g-0 m-auto container py-2 d-flex justify-content-around align-items-between py-sm-5">
        ...
        <div className="col-md-4 Cardpadding">
            ...
            <div className="cardbody positive-relative">
                <p className='cardbodypara py-2'>
