...
const Service = () => {
  return (
    <>
     ...
     <div className="col-6">
        <p className='servicepara'>
        You have come to the Right Place PixarsArt is a Unified Platform for all things of Web & Mobile
     ...
     <div className="butto  text-white">
        ...
        <div className="container row m-auto">
            <div className="col-2 serviceimg ">
                <img className='serviceimage h-100' src="Creative Design.png" alt="" />
            </div>
            <div className="col-10 d-flex flex-column justify-content-between align-items-center py-5 ">
              <div className=" d-flex justify-content-between align-items-center servicecontent">
                <h4 className='px-3 Serviceheading'>
                    01
                </h4>
                <h4 className='px-3 Serviceheading'>
                Awesome Creative Design
                </h4>
                <p className='px-3 servicepara'>
                Creative Designs are basic requirement
                of all businesses. PixarsArt is the right
                choice for you to initiate this process.
                </p>
