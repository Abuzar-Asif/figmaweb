      ...
      <div className="container-fluid">
        <div className="row container m-auto d-flex justify-content-center align-items-center ">
          ...
          <div className="col-md-6">
            <p className="servicepara">You have come to the Right Place PixarsArt is a Unified Platform for all things of Web & Mobile</p>
          </div>
        ...
        <div className="container row m-auto">
          ...
          <div className="col-md-8 d-flex flex-column justify-content-between align-items-center py-5 ">
